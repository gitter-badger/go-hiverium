...
var (
	...
	app = utils.NewApp(gitCommit, "the und mainchain command line interface")
...
func und(ctx *cli.Context) error {
...
// miner.
func startNode(ctx *cli.Context, stack *node.Node, cfg undConfig) {
