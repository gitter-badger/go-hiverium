...
import (
	...
	"github.com/unification-com/mainchain/internal/debug"
	...
	"github.com/unification-com/mainchain/swarm"
	bzzapi "github.com/unification-com/mainchain/swarm/api"
	swarmmetrics "github.com/unification-com/mainchain/swarm/metrics"
...
func bzzd(ctx *cli.Context) error {
	...
	//und only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for und and swarm
