...
import (
	...
	"github.com/unification-com/mainchain/common/fdlimit"
	"github.com/unification-com/mainchain/consensus"
	"github.com/unification-com/mainchain/consensus/ethash"
	"github.com/unification-com/mainchain/consensus/posv"
	...
	"github.com/unification-com/mainchain/dashboard"
	"github.com/unification-com/mainchain/eth"
	"github.com/unification-com/mainchain/eth/downloader"
	"github.com/unification-com/mainchain/eth/gasprice"
	"github.com/unification-com/mainchain/ethdb"
	"github.com/unification-com/mainchain/ethstats"
	"github.com/unification-com/mainchain/les"
	...
	"github.com/unification-com/mainchain/p2p/discv5"
	"github.com/unification-com/mainchain/p2p/nat"
	"github.com/unification-com/mainchain/p2p/netutil"
	"github.com/unification-com/mainchain/params"
	whisper "github.com/unification-com/mainchain/whisper/whisperv6"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 50002=UND Mainchain mainnet)",
...
// for und and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `und account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	if ctx.GlobalIsSet(StoreRewardFlag.Name) {
		common.StoreRewardFolder = filepath.Join(stack.DataDir(), "und", "rewards")
...
// new format.
//
// e.g. und account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// und --keystore /tmp/mykeystore --lightkdf account new
//
